...
@storage_var
func latest_tx_timestamp() -> (res: felt) {
}
...
func __execute__{
    ...
    latest_tx_timestamp.write(timestamp);
...
@view
func getLatestTxTimestamp{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    timestamp: felt
) {
    let (res) = latest_tx_timestamp.read();
